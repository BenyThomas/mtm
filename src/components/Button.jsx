...
export const Button = ({
  ...
  const variantClasses = {
    primary: 'border-transparent bg-[var(--tenant-primary)] text-white shadow-md hover:-translate-y-[1px] hover:opacity-90 ring-offset-white dark:ring-offset-gray-900',

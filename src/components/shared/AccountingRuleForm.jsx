      ...
      try {
        ...
        const list =
          listRes.status === "fulfilled"
            ? Array.isArray(listRes.value.data)
              ? listRes.value.data
              : listRes.value.data?.pageItems || []
            : [];
    ...
    <form onSubmit={submit} className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          {errors.debitIds ? (
            <p className="text-xs text-red-500 mt-1">{errors.debitIds}</p>
          ) : null}
        </div>
        ...
        <div>
          ...
          {errors.creditIds ? (
            <p className="text-xs text-red-500 mt-1">{errors.creditIds}</p>
          ) : null}
        </div>
      </div>

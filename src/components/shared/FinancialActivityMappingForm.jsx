...
const FinancialActivityMappingForm = ({ initial, onSubmit, submitting }) => {
  ...
  useEffect(() => {
    ...
    setFinancialActivityId(
      initial.financialActivityId != null
        ? String(initial.financialActivityId)
        : ""
    );
    setGlAccountId(
      initial.glAccountId != null ? String(initial.glAccountId) : ""
    );
    setErrors({});
  }, [initial]);
  ...
  const validate = () => {
    const e = {};
    if (!financialActivityId)
      e.financialActivityId = "Financial activity is required";
  ...
  const onFAChange = (v) => {
    ...
    if (errors.financialActivityId)
      setErrors((x) => ({ ...x, financialActivityId: "" }));
  };

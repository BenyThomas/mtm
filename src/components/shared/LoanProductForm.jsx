...
const LoanProductForm = ({ initial, onSubmit, submitting }) => {
      ...
      try {
        ...
        if (!cancelled && res?.data) {
          setTpl({
            ...
            interestTypeOptions:
              res.data.interestTypeOptions ||
              FALLBACK_TEMPLATE.interestTypeOptions,
            interestCalculationPeriodTypeOptions:
          ...
          if (!initial) {
            const firstStrat = (res.data.transactionProcessingStrategyOptions ||
              [])[0];
            if (firstStrat?.id) {
              setForm((f) => ({
                ...f,
  ...
  useEffect(() => {
    ...
    setForm((f) => ({
      ...
      shortName:
        initial.shortName ||
        (initial.shortName === 0 ? "0" : initial.shortName) ||
        "",
      currencyCode:
        initial.currency?.code || initial.currencyCode || f.currencyCode,
      digitsAfterDecimal:
      ...
      rateMin:
        initial.interestRatePerPeriod?.minimum ??
        initial.minInterestRatePerPeriod ??
        "",
      rateDefault:
        ...
        "",
      rateMax:
        initial.interestRatePerPeriod?.maximum ??
        initial.maxInterestRatePerPeriod ??
        "",
      ...
      numRepaymentsMin:
        initial.numberOfRepayments?.minimum ??
        initial.minNumberOfRepayments ??
        "",
      numRepaymentsDefault:
        initial.numberOfRepayments?.default ?? initial.numberOfRepayments ?? "",
      numRepaymentsMax:
        initial.numberOfRepayments?.maximum ??
        initial.maxNumberOfRepayments ??
        "",
  ...
  const validate = () => {
    ...
    if (
      form.numRepaymentsDefault === "" ||
      Number(form.numRepaymentsDefault) <= 0
    ) {
  ...
  const buildPayload = () => {
    const payload = {
      ...
      transactionProcessingStrategyId: Number(
        form.transactionProcessingStrategyId
      ),
    ...
    if (isAccountingEnabled) {
      ...
      payload.incomeFromPenaltyAccountId = Number(
        form.incomeFromPenaltyAccountId
      );
      payload.writeOffAccountId = Number(form.writeOffAccountId);
      payload.overpaymentLiabilityAccountId = Number(
        form.overpaymentLiabilityAccountId
      );

      if (isAccrual) {
        payload.receivableInterestAccountId = Number(
          form.receivableInterestAccountId
        );
        payload.receivableFeeAccountId = Number(form.receivableFeeAccountId);
        payload.receivablePenaltyAccountId = Number(
          form.receivablePenaltyAccountId
        );
      }
    }
      ...
      <Card>
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            {errors.currencyCode && (
              <p className="text-xs text-red-500 mt-1">{errors.currencyCode}</p>
            )}
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setField("interestRateFrequencyType", e.target.value)
              }
              className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
            >
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setField("repaymentFrequencyType", e.target.value)
              }
              className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
            >
          ...
          <div>
            <label className="block text-sm font-medium">
              Interest Calc Period *
            </label>
            <select
              value={form.interestCalculationPeriodType}
              onChange={(e) =>
                setField("interestCalculationPeriodType", e.target.value)
              }
              className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
            >
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setField("transactionProcessingStrategyId", e.target.value)
              }
              className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
            >
                  ...
                  return (
                    <label key={id} className="inline-flex items-center gap-2">
                      ...
                      <span className="text-sm">
                        {ch.name}{" "}
                        {ch.currency?.code ? `(${ch.currency.code})` : ""}
                      </span>
                    </label>
                  );
                })
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("fundSourceAccountId", e.target.value)
                    }
                    className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("loanPortfolioAccountId", e.target.value)
                    }
                    className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                  >
                    <option value="">Select</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("interestOnLoanAccountId", e.target.value)
                    }
                    className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                  >
                    <option value="">Select</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("incomeFromFeeAccountId", e.target.value)
                    }
                    className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                  >
                    <option value="">Select</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("incomeFromPenaltyAccountId", e.target.value)
                    }
                    className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                  >
                    <option value="">Select</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("writeOffAccountId", e.target.value)
                    }
                    className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                  >
                    <option value="">Select</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setField("overpaymentLiabilityAccountId", e.target.value)
                    }
                    className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                  >
                    <option value="">Select</option>
            ...
            {isAccrual && (
              <div>
                <div className="font-medium mb-2">
                  Accrual Accounts (Periodic)
                </div>
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium">
                      Receivable Interest (Asset) *
                    </label>
                    <select
                      value={form.receivableInterestAccountId}
                      onChange={(e) =>
                        setField("receivableInterestAccountId", e.target.value)
                      }
                      className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                    >
                      <option value="">Select</option>
                  ...
                  <div>
                    <label className="block text-sm font-medium">
                      Receivable Fees (Asset) *
                    </label>
                    <select
                      value={form.receivableFeeAccountId}
                      onChange={(e) =>
                        setField("receivableFeeAccountId", e.target.value)
                      }
                      className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                    >
                      <option value="">Select</option>
                  ...
                  <div>
                    <label className="block text-sm font-medium">
                      Receivable Penalties (Asset) *
                    </label>
                    <select
                      value={form.receivablePenaltyAccountId}
                      onChange={(e) =>
                        setField("receivablePenaltyAccountId", e.target.value)
                      }
                      className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
                    >
                      <option value="">Select</option>

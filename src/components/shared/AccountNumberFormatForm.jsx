...
const Audits = () => {
  ...
  const toneForResult = (r) => {
    ...
    if (v.includes("success") || v.includes("approved") || v === "true")
      return "green";
    if (v.includes("reject") || v.includes("failed") || v === "false")
      return "red";
    return "gray";
  };
    ...
    <div className="space-y-6">
      ...
      <Card>
                ...
                {filteredClientSide.map((a) => (
                  ...
                  >
                    ...
                    <td className="py-2 pr-4">
                      {toISO(a.madeOnDate || a.makerDateTime || a.createdDate)}
                    </td>
                    <td className="py-2 pr-4">
                      {a.maker || a.makerName || a.makerId || "-"}
                    </td>
                    <td className="py-2 pr-4">{a.actionName}</td>
                    <td className="py-2 pr-4">{a.entityName}</td>
                    <td className="py-2 pr-4">{a.resourceId ?? "-"}</td>
                    <td className="py-2 pr-4">
                      {a.officeName || a.officeId || "-"}
                    </td>
                    <td className="py-2 pr-4">
                      <Badge tone={toneForResult(a.processingResult)}>
                        {String(a.processingResult ?? "-")}
                      </Badge>
                    </td>
                    <td className="py-2 pr-4">
                      <Button
        ...
        <div className="mt-4 flex items-center justify-between text-sm">
          <div>
            Showing <span className="font-medium">{pageFrom}</span>–

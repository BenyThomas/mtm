...
const GlAccountForm = ({ initial, onSubmit, submitting }) => {
  ...
  useEffect(() => {
    ...
    setManualEntriesAllowed(
      initial.manualEntriesAllowed != null
        ? Boolean(initial.manualEntriesAllowed)
        : true
    );
    ...
    <form onSubmit={submit} className="space-y-4">
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          />
          {errors.glCode ? (
            <p className="text-xs text-red-500 mt-1">{errors.glCode}</p>
          ) : null}
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          {errors.usageId ? (
            <p className="text-xs text-red-500 mt-1">{errors.usageId}</p>
          ) : null}
        </div>
      </div>

...
const StandingInstructionForm = ({ initial, onSubmit, submitting }) => {
  ...
  const [recurrenceOnDay, setRecurrenceOnDay] = useState(
    initial?.recurrenceOnDay || ""
  );
    ...
    (async () => {
      ...
      try {
        ...
        setFromAccountOptions(
          normalize(
            d?.fromAccountOptions || d?.fromAccounts || [],
            "id",
            "name"
          )
        );
        setToAccountOptions(
          normalize(d?.toAccountOptions || d?.toAccounts || [], "id", "name")
        );
        setAccountTypeOptions(
          normalize(
            d?.accountTypeOptions || d?.accountTypes || [],
            "id",
            "name"
          )
        );
        setTransferTypeOptions(
          normalize(
            d?.transferTypeOptions || d?.transferTypes || [],
            "id",
            "name"
          )
        );
        ...
        setRecurrenceTypeOptions(
          normalize(d?.recurrenceTypeOptions || [], "id", "name")
        );
      } catch (_e) {
        if (!cancelled) {
          setFromAccountOptions([]);

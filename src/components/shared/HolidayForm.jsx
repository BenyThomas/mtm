...
const HolidayForm = ({ initial, onSubmit, submitting }) => {
    ...
    (async () => {
      ...
      try {
        ...
        const list = Array.isArray(r.data)
          ? r.data
          : r.data?.pageItems || r.data?.officeOptions || [];
  ...
  useEffect(() => {
    ...
    const ids = initial.offices?.map((o) => o.id) || initial.officeIds || [];
  ...
  return (
    <form onSubmit={submit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (errors.fromDate) setErrors((x) => ({ ...x, fromDate: "" }));
              }}
              className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
            />
            {errors.fromDate && (
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (errors.toDate) setErrors((x) => ({ ...x, toDate: "" }));
              }}
              className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
            />
            {errors.toDate && (
      ...
      <Card>
        ...
        {errors.offices && (
          <p className="text-xs text-red-500 mt-2">{errors.offices}</p>
        )}
      </Card>

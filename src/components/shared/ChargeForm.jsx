...
const ChargeForm = ({ initial, onSubmit, submitting }) => {
  ...
  const norm = (arr, idKey = "id", nameKey = "name") => {
    ...
    return arr
      .map((o) => ({
        ...
        name:
          o?.[nameKey] ?? o?.text ?? o?.label ?? o?.name ?? String(o?.id ?? ""),
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const calcTypes =
          d?.chargeCalculationTypeOptions || d?.calculationTypeOptions || [];
  ...
  const validate = () => {
    ...
    if (!chargeCalculationType)
      e.chargeCalculationType = "Calculation Type is required";
    setErrors(e);
  ...
  const submit = async (ev) => {
    ...
    const payload = {
      ...
      ...(chargePaymentMode
        ? { chargePaymentMode: Number(chargePaymentMode) }
        : {}),
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (errors.chargeAppliesTo)
                    setErrors((x) => ({ ...x, chargeAppliesTo: "" }));
                }}
                className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (errors.chargeTimeType)
                    setErrors((x) => ({ ...x, chargeTimeType: "" }));
                }}
                className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
              >
                <option value="">Select…</option>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (errors.chargeCalculationType)
                    setErrors((x) => ({ ...x, chargeCalculationType: "" }));
                }}
                className="mt-1 w-full border rounded-md p-2 dark:bg-gray-700 dark:border-gray-600"
              >
                <option value="">Select…</option>

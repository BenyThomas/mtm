...
import { Plus, Search, Filter, Download, Currency } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-2">
        <div className="relative flex-1 max-w-sm">
          ...
          <input placeholder="Search currencies..." className="pl-8 w-full" />
        </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            <p className="text-muted-foreground">
              No currencies found. Start by adding your first currency.
            </p>
          </div>
        </CardContent>
      </Card>

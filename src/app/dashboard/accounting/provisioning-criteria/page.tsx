    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure loan loss provisioning criteria and rules.
          </p>
        </div>
        <Button>
      ...
      <div className="flex items-center space-x-2">
        <div className="relative flex-1 max-w-sm">
          ...
          <input placeholder="Search criteria..." className="pl-8 w-full" />
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Provisioning Criteria Management</CardTitle>
          <CardDescription>
            Configure loan loss provisioning criteria and rules
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8">
            <p className="text-muted-foreground">
              No provisioning criteria found. Start by adding your first
              criteria.
            </p>
          </div>
        </CardContent>
